...
export default function Projects() {
    return (
        <Swiper spaceBetween={50} className="w-full project__slide aspect-video mb-[5rem]" autoplay={{ delay: 7000 }} navigation={true} pagination={{ clickable: true, dynamicBullets: true }} modules={[Autoplay, Navigation, Pagination]}>
            <SwiperSlide>
