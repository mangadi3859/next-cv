...
export default function ContentCard({ className, ...props }: any) {
    return (
        <div className={`card__content min-w-[80%] text-white bg-black bg-opacity-80 px-10 py-6 h-auto`}>
            ...
            <p className="mt-12 text-md font-thin phone-lg:mt-4">
            ...
            <p className="mt-4 text-md font-thin ">I'm currently an intern in PT. Taksu Teknologi Indonesia. I'm extremely excited about working and would love to help!</p>
        </div>
    );
}
